...
function load(options) {
  ...
  const result = gyp.input.load({
    ...
    check: !!options.check,
    circularCheck: options.circularCheck !== false,
    duplicateBasenameCheck: options.duplicateBasenameCheck !== false,
...
gyp.main = function main(args) {
  ...
  const loadRes = load({
    ...
    params: params,
    check: options.check,
    circularCheck: options.circular_check,
    duplicateBasenameCheck: options.duplicate_basename_check
  });
