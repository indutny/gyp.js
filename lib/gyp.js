...
function load(buildFiles, format, defaultVariables, includes, depth, params,
              check, circularCheck, duplicateBasenameCheck) {
  defaultVariables = defaultVariables || {};
  includes = includes || [];
  depth = depth || '.';
  check = !!check;
  circularCheck = circularCheck !== false;
  duplicateBasenameCheck = duplicateBasenameCheck !== false;
...
gyp.main = function main(args) {
  ...
  const loadRes = load(buildFiles, 'ninja',
