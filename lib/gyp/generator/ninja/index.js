...
NinjaMain.prototype.vars = function vars() {
  ...
  if (exports.generatorSupportsMultipleToolsets) {
    main.declare('cc_host', env.CC_host || cc);
    main.declare('cxx_host', env.CXX_host || cc);
    main.declare('ld_host', env.CC_host || cc);
    main.declare('ldxx_host', env.CXX_host || cc);
    main.declare('ar_host', env.AR_host || ar);
  }
